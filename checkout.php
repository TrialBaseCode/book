...
<div class="breadcrumb-containar">
  <div class="container">
     <div class="row">
        <div class="col-lg-5">
          <ol class="breadcrumb secondary-color mb-0">
            <li class="breadcrumb-item"><a class="white-text" href="index">Home</a></li>
            <li class="breadcrumb-item"><a class="white-text" href="shop">Shop</a></li>
			<li class="breadcrumb-item"><a class="white-text" href="cart">Cart</a></li>
